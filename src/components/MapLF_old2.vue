    ...
    export default {
        ...
        created() {
            EventBus.$on("mapViewMode", inputWord => {
                console.log('mapViewMode - '+inputWord);
            });
        },
        mounted() {
            let vm = this;
        ...
        methods: {
            /**
             * добавляем маркеры из набора данных
             **/
            ...
            createTraffLight1: function() {
                ...
                function onMapClick(e) {
                    ...
                    vm.drawedObjects['tl'].push({
                        ...
                        'obj': trafLight1,
                        'supid': vm.drawedObjects['sup'].slice(-1).pop().oid,
                        'supobj': vm.drawedObjects['sup'].slice(-1).pop()
                    });
                    vm.drawLine(vm.drawedObjects['sup'].slice(-1).pop(), trafLight1);
            ...
            redrawLine: function(obj, obj2) {
                ...
                // console.log(obj.target._leaflet_id);
                // console.log(vm.drawedObjects['lines']);
                // let tlid = obj.sourceTarget._leaflet_id;
